...
export let noteDataArray: NoteDataInterface[] = [
  {
    id: 1,
    title: "Meeting Notes",
    content: "Discussed Q3 goals and project timelines.",
  },
  { id: 2, title: "Shopping List", content: "Milk, bread, eggs, and coffee." },
  {
    id: 3,
    title: "Ideas for New App",
    content: "A social network for cat lovers.",
  },
  {
    id: 4,
    title: "Checking",
    content: "A social network for lovers.",
  },
];

export interface convexSchemaInterface {
  _id: any;
  content: string;
  title: string;
  _creationTime: Date;
